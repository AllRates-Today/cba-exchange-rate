// Central Bank of Armenia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cba';
...
/** Latest rate for one pair, e.g. getRate('USD', 'AMD', { apiKey }). */
